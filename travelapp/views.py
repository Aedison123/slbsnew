...
#     return redirect('')  # You can replace 'login' with the name of your login page URL pattern
...
def logout_view(request):
    logout(request)
    # Redirect to a success page or homepage
    return redirect('login')  # You can replace 'home' with the name of your homepage URL pattern
